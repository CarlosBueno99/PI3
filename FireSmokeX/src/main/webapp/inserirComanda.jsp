    ...
    <body>
        ...
        <div class="row" style="margin-left: 0px;">
            <div class="col-md-6">
                ...
                <span>Código do Produto: </span> <input type="search" name="buscaProd" readonly="readonly"> <button>Buscar</button> <br><br>
                <span>Produto:</span> <input type="text" readonly="readonly"> <!-- Nome do produto que vai ser puxado no SKU acima--> 
                <span>Quantidade</span> <input type="number" style="width:40px" value="1" readonly="readonly">
                <br>
